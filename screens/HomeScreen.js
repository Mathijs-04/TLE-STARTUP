        ...
        <SafeAreaView style={styles.container}>
            <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
                ...
                {hasGarden ? (
                    ...
                    <View style={[styles.gardenCard, styles.emptyGardenCard]}>
                        <Text style={styles.gardenTitle}>Nog geen tuin aangemaakt!</Text>
                        <Text style={styles.gardenDetail}>Maak eerst een tuin aan om statistieken te bekijken.</Text>
                        <TouchableOpacity style={styles.backButton}
                                          onPress={() => navigation.navigate('Garden', {screen: 'Instellingen'})}
                        >
                            <Text style={styles.backButtonText}>Maak een tuin aan!</Text>
                        </TouchableOpacity>
                    </View>
                )}
